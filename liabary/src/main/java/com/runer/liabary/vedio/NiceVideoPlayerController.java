package com.runer.liabary.vedio;
...
public class NiceVideoPlayerController extends FrameLayout
    ...
    public  interface  OnFullViewClickListener{
        void onVideoClick(View v);
    }
    public interface  OnPlayIconClickListener{
        void onPlayIconClick(View view);
    }
    ...
    private OnFullViewClickListener onFullViewClickListener ;
    public void setOnFullViewClickListener(OnFullViewClickListener onFullViewClickListener) {
        this.onFullViewClickListener = onFullViewClickListener;
    }

    private void init() {
        View container =LayoutInflater.from(mContext).inflate(R.layout.nice_video_palyer_controller, this, true);

        container.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {

                if(onFullViewClickListener!=null){
                    onFullViewClickListener.onVideoClick(v);
                }
            }
        });
    ...
    public void onClick(View v) {
        if (v == mCenterStart) {
            if(onPlayIconClickListener!=null){
                onPlayIconClickListener.onPlayIconClick(v);
            }else{
                if (mNiceVideoPlayer.isIdle()) {
