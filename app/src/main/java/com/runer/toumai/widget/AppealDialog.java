...
public class AppealDialog extends Dialog {
    ...
    public AppealDialog(@NonNull Context context, @StyleRes int themeResId) {
        super(context, themeResId);
    }

    protected AppealDialog(@NonNull Context context, boolean cancelable, @Nullable OnCancelListener cancelListener) {
    ...
    public static SelectPhotoView show(final Context context , SelectPhotoView.OnItemSelectPicClickListener onItemSelectPicClickListener , GoodListBean goodListBean, final OnCommitClickListener onCommitClickListener) {
        final AppealDialog dialog = new AppealDialog(context, com.runer.liabary.R.style.ProgressHUD);
        dialog.setTitle("");
        dialog.setContentView(R.layout.appeal_layout);
    ...
    public interface  OnCommitClickListener{
        void onCommitClick(String content ,AppealDialog appealDialog);
    }
