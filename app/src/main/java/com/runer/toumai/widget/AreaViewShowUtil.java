...
import com.runer.toumai.bean.JsonBean;
...
public class AreaViewShowUtil   {

    private Context context ;
    public AreaViewShowUtil (Context context){
        ...
        OptionsPickerView pvOptions = new OptionsPickerView.Builder(context, new OptionsPickerView.OnOptionsSelectListener() {
            ...
            public void onOptionsSelect(int options1, int options2, int options3, View v) {
                ...
                if(onAreaSelectListener!=null){
                    onAreaSelectListener.onAreaSelect(options1Items.get(options1).getPickerViewText(), options2Items.get(options1).get(options2), options3Items.get(options1).get(options2).get(options3));
                }
                ...
                .setCancelColor(ContextCompat.getColor(context, R.color.text_color_light))//取消按钮文字颜色
                .setTitleText("城市选择")
                .setOutSideCancelable(true)
                .setDividerColor(ContextCompat.getColor(context, R.color.text_color_gray))
                .setTextColorCenter(ContextCompat.getColor(context, R.color.text_color_normal)) //设置选中项文字颜色
    ...
    public ArrayList<JsonBean> parseData(String result) {//Gson 解析
        ...
        try {
            ...
            detail =JsonUtil.node2pojoList(node,JsonBean.class);
    ...
    public interface  OnAreaSelectListener{
        void onAreaSelect(String pro ,String city ,String area);
    }
}
